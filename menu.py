...
from admini import Ui_Form as AdminiForm
from clienti import Ui_Form as clientiForm
#from list import Ui_Dialog as inscrip
...
class MyApp(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.uiform2 = AdminiForm()
        self.uiform2.setupUi(Form)
    ...
    def check_email(self):
        ...
        cnxc = mysql.connector.connect(user="root", password="", host="localhost", database="location_voiture")
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionInscrire.triggered.connect(self.open_dialog)       
    ...
    def affiche_liste(self):
        if self.email_edit.text() == "Admin@gmail.com" and self.password_edit.text() == "admin":
            self.admin_form = QtWidgets.QWidget()
            self.ui = AdminiForm()
            self.ui.setupUi(self.admin_form)
            self.admin_form.show()
            self.close()
        else:
            self.client_form = QtWidgets.QWidget()
            self.ui = clientiForm()
            self.ui.setupUi(self.client_form)
